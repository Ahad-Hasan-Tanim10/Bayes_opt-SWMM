...
for trial in study:
    ...
    p1.append(trial.parameters['a'])
    p2.append(trial.parameters['a3'])
    p3.append(trial.parameters['a4'])
    p4.append(trial.parameters['i'])
    p5.append(trial.parameters['h'])
    p6.append(trial.parameters['p'])
    print(pseudo_loss)
