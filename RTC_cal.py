...
inp = read_inp_file(r'C:\Users\ATANIM\Documents\Research\Rocky branch\Flood\Calibration_rtc22_1.inp', convert_sections=[SUBCATCHMENTS,SUBAREAS, INFILTRATION, TRANSECTS])  # type: swmm_api.SwmmInput
...
vf_dis1= vf_dis1.loc["8/25/2022 7:00":"8/25/2022 09:30"]
vf_dep1= vf_dep1.loc["8/25/2022 7:00":"8/25/2022 09:30"]
#%%
...
def dis(mod, obs):
    ...
    #dep= dep.loc["8/25/2022 06:30":"8/25/2022 10:30"]### define the ranage
...
def runf(fn):
    ...
    # using this line below, we turn the 3 columns into a table, called DataFrame using the pandas library. So that we can plot it.
        ...
        df1= df.loc["8/25/2022 7:00":"8/25/2022 09:30"]#report start and end time
        return df1
#%%
