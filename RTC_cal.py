...
inp = read_inp_file(r'C:\Users\ATANIM\Documents\Research\Rocky branch\Flood\Calibration_rtc2022.inp', convert_sections=[SUBCATCHMENTS,SUBAREAS, INFILTRATION, TRANSECTS])  # type: swmm_api.SwmmInput
...
def rep(ri, txt1, txt2, txt3, txt4):
    for item in ri.split("\n"):
        if "START_DATE           " in item:
            ri1 = ""
            ri1= ri1+ item.strip()
            ...
            rft2 = rft1.replace(rft1[21:25], txt4)
...
inp[sections.OPTIONS] = rep(inp[sections.OPTIONS], '08/24/2022', '16:3','08/25/2022','22:0')
# slice a dataframe based on start and ending point
vf_dis1= vf_dis1.loc["8/24/2022 16:30":"8/25/2022 22:00"]
vf_dep1= vf_dep1.loc["8/24/2022 16:30":"8/25/2022 22:00"]
#%%
...
fr33(a[max_id],b[max_id],c[max_id],d[max_id],e[max_id],f[max_id],g[max_id], a3[max_id], b3[max_id], 
     c3[max_id], d3[max_id], e3[max_id], f3[max_id], g3[max_id],
...
p_best = [a[max_id],b[max_id],c[max_id],d[max_id],e[max_id],f[max_id],g[max_id], a3[max_id], b3[max_id], 
     c3[max_id], d3[max_id], e3[max_id], f3[max_id], g3[max_id],
               a4[max_id], b4[max_id], c4[max_id], d4[max_id], e4[max_id], f4[max_id], g4[max_id],
               i[max_id],j[max_id],k[max_id],l[max_id], h[max_id], m[max_id], n[max_id],o[max_id], 
               p[max_id], q[max_id], r[max_id], s[max_id]]